\section{Results and discussion.}
  ...
  The efficiency is the fraction of events selected according to the Eq. \ref{eq:Eff}:
	...
	Charge distribution of AD1 (left) and AD2 (right) modules with particles from the PS beam. %
				...
				%, the efficiency was calculatedZ				according to the equations \ref{eq:Eff} and \ref{eq:Eff1_error}.
	  		}
	...
	\begin{figure}[hb!]
	  \begin{center}
		\includegraphics[scale=0.40]{./images/time/1GeV/NotepPiSelH1.eps}%%NotepPiSelH1.pdf}%NotepPiSelH1_1GeV.pdf}
		\caption{
	...
	\begin{figure}[h!]
	  \begin{center}
	\includegraphics[scale=0.55]{./images/time/1GeV/NoteSlewH2.eps}%NoteSlewH2_1GeV.pdf}
	\caption{
	...
	row) the slewing correction.% 
		...
		\begin{figure}[ht!]
			\begin{center}
				\includegraphics[scale=0.70]{./images/time/1GeV/NoteSlewH1.eps}%NoteSlewH1_1GeV.pdf}
				\caption{
		Time of flight difference  between AD  %pions and protons at 1 GeV/c beam momentum of 
		...
		fitted to the pions and protons distributions. %($\Delta t= t(\text{AD})-t(\text{T0 end}))$
	...
	%for the PMT glass of the vacuum tube and the aluminum cover we will consider 1 mm in the front and 1 mm more in the back, and finally the 16 dynodes are made of 0.1 mm thick iron (Fe).
	...
	\begin{figure}[hb!]
	  \begin{center}
	\includegraphics[scale=0.50]{./images/time/1GeV/NoteQ.eps}%NoteQ_1GeV.pdf}
	\caption{
    ...
    \begin{table*}[t]
      \centering
	\caption{Time resolutions of AD1 and AD2 at different momenta of pions and protons with and without time slewing correction.}
      \scalebox{0.87}{
	\begin{tabular}{ | c||c c|c c||c c|c c|} \hline
		...
		&\multicolumn{2}{c}{$\sigma$ (ns)} & \multicolumn{2}{c|}{Slewing corr. $\sigma$ (ns)} \\ \hline
	...
	Momentum& 	\multicolumn{6}{c|}{Charge (ADC counts)} \\ %\hline
	(GeV/c) &\multicolumn{3}{c}{AD1} & \multicolumn{3}{c|}{AD2} \\ \hline\hline
   ...
   %% Charge Other regions
	...
	\begin{table}[ht!]
		...
		\begin{tabular}{ |c||c c c c |c c c c| }
			...
			Momentum* & \multicolumn{4}{ c|}{Theoretical estimation}&
		 \multicolumn{4}{c|}{ Energy deposition measurement}   \\% \cline{2-9}
			(MeV/c) & \multicolumn{2}{ c}{AD1 (MeV)}& 
			\multicolumn{2}{c|}{AD2 (MeV)}& 
			\multicolumn{2}{c}{AD1 (MeV/ADC)}&
		 \multicolumn{2}{c|}{AD2 (MeV/ADC)}   \\  \hline%\cline{2-9}
			        & $\pi^+$& $p^+$& $\pi^+$& $p^+$ &  	$\pi^+$& $p^+$& $\pi^+$& $p^+$ \\ 
